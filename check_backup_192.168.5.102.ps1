...
$source = "\\192.168.5.86\backup_server\192.168.5.102\1CData\*.TIB"
...
$source = "\\192.168.5.86\backup_server\192.168.5.102\sql\*.TIB"
$file = Get-ChildItem -Path $source | Sort-Object LastWriteTime | Select-Object -Last 1
$date_creation = $file.LastWriteTime.toString("dd/MM/yyyy")
if($date_creation -eq $CurrentDate) {
...
$source = "\\192.168.5.86\backup_server\192.168.5.102\MSQQL_bak\*.TIB"
$file = Get-ChildItem -Path $source | Sort-Object LastWriteTime | Select-Object -Last 1
$date_creation = $file.LastWriteTime.toString("dd/MM/yyyy")
if($date_creation -eq $CurrentDate) {
...
$source = "\\192.168.5.86\backup_server\192.168.5.102\1c8_srvinfo\*.TIB"
$file = Get-ChildItem -Path $source | Sort-Object LastWriteTime | Select-Object -Last 1
$date_creation = $file.LastWriteTime.toString("dd/MM/yyyy")
if($date_creation -eq $CurrentDate) {
